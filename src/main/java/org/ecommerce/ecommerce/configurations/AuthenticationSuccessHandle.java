...
public class AuthenticationSuccessHandle implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        new DefaultRedirectStrategy().sendRedirect(request, response, "https://furniture-app-git-front-end-chippo156s-projects.vercel.app/?access_token=" + token+"&providerId="+id);
    }
}
